...
bool create3_msgs__msg__armcontrol__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("create3_msgs.msg._armcontrol.Armcontrol", full_classname_dest, 39) == 0);
  }
  create3_msgs__msg__Armcontrol * ros_message = _ros_message;
  {  // pos
...
PyObject * create3_msgs__msg__armcontrol__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("create3_msgs.msg._armcontrol");
