...
static const _Armcontrol_type_support_symbol_names_t _Armcontrol_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, create3_msgs, msg, Armcontrol)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, create3_msgs, msg, Armcontrol)),
  }
};
...
{
  return &::create3_msgs::msg::rosidl_typesupport_cpp::Armcontrol_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, create3_msgs, msg, Armcontrol)() {
  return get_message_type_support_handle<create3_msgs::msg::Armcontrol>();
}
